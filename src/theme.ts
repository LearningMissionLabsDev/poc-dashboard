...
declare module '@mui/material/styles' {
  ...
  interface TypographyVariants { mobileMenu: React.CSSProperties, custom: React.CSSProperties, button: React.CSSProperties, miniBody: React.CSSProperties; }
  interface TypographyVariantsOptions { mobileMenu?: React.CSSProperties, custom?: React.CSSProperties, button?: React.CSSProperties, miniBody: React.CSSProperties; }
  interface TypographyPropsVariantOverrides { mobileMenu: true, custom: true, button: true, miniBody: true; }
}
